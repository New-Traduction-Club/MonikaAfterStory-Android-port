...
public class SDLActivity extends Activity {
    ...
    public static boolean isRenpy853Engine = false;

    public static boolean isRenpy7OrLater() {
        return isRenpy7Engine || isRenpy7411Engine || isRenpy803Engine || isRenpy8Engine || isRenpy841Engine || isRenpy853Engine;
    }
    ...
    static class ShowTextInputTask implements Runnable {
        ...
        public void run() {
            ...
            AbsoluteLayout.LayoutParams params = new AbsoluteLayout.LayoutParams(
                    width, height + HEIGHT_PADDING, x, y);
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        if (SDLActivity.isRenpy7OrLater()) {
            String library;
            if (SDLActivity.isRenpy853Engine) {
                library = "lib853renpython.so";
            } else if (SDLActivity.isRenpy841Engine) {
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public boolean onKey(View  v, int keyCode, KeyEvent event) {
        Log.v("SDL", "onKey: keyCode=" + keyCode + ", action=" + event.getAction() + ", source=" + event.getSource());
...
class DummyEdit extends View implements View.OnKeyListener {
    ...
    @Override
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        Log.v("SDL", "DummyEdit.onKey: keyCode=" + keyCode + ", action=" + event.getAction());
...
class SDLInputConnection extends BaseInputConnection {
    ...
    public boolean sendKeyEvent(KeyEvent event) {
        Log.v("SDL", "SDLInputConnection.sendKeyEvent: keyCode=" + event.getKeyCode() + ", action=" + event.getAction());
        /*
    ...
    public boolean commitText(CharSequence text, int newCursorPosition) {
        Log.v("SDL", "SDLInputConnection.commitText: text=" + text);
